...
export default {
  ...
  "ui.about.plugin_version": "插件版本",
  "ui.about.server_version": "服务端版本",
  "ui.notice.restore_version_failed": "恢复版本请求失败",
  "ui.notice.restore_note_failed": "恢复笔记失败",
  "ui.notice.restore_file_failed": "恢复文件失败",
  "ui.notice.delete_file_failed": "删除文件失败",
  "ui.notice.permanent_delete_failed": "永久删除失败",
  "ui.notice.clear_recycle_bin_failed": "清空回收站失败",
  "ui.notice.create_share_failed": "创建分享失败",
  "ui.notice.set_password_failed": "设置密码失败",
  "ui.notice.generate_short_link_failed": "生成短链接失败",
  "ui.notice.cancel_share_failed": "取消分享失败",
  "ui.notice.recycle_restored": "成功恢复 ${count} 个项目",
  "ui.notice.version_download_extract": "下载成功，正在解密与提取文件...",
  "ui.notice.file_hash_init_start": "正在初始化文件哈希映射...",
  "ui.notice.file_hash_init_progress": "正在初始化文件哈希映射... (${done}/${total})",
  "ui.notice.file_hash_init_done": "文件哈希映射初始化完成! 共处理 ${total} 个文件",
  "ui.notice.file_hash_init_failed": "文件哈希映射初始化失败: ${msg}",
  "ui.notice.file_hash_save_failed": "保存文件哈希映射失败: ${msg}",
  "ui.notice.config_hash_init_start": "正在初始化配置哈希映射...",
  "ui.notice.config_hash_init_progress": "正在初始化配置哈希映射... (${done}/${total})",
  "ui.notice.config_hash_init_done": "配置哈希映射初始化完成! 共处理 ${total} 个配置",
  "ui.notice.config_hash_init_failed": "配置哈希映射初始化失败: ${msg}",
  "ui.notice.config_hash_save_failed": "保存配置哈希映射失败: ${msg}",
  "ui.notice.file_hash_manager_timeout": "文件哈希管理器初始化超时,同步可能不稳定",
  "ui.notice.connection_retrying": "同步连接持续失败，将继续在后台重试",
  "ui.conflict.list_count": "${count} 个文件冲突",
  "ui.conflict.list_empty": "当前无发生冲突的笔记",
  "ui.conflict.diff_skipped": "文件较大，已跳过逐行差异对比。可点击上方按钮选用本地/远端版本，或在右侧编辑器直接编辑。",
  "ui.status.label_note": "笔记",
  "ui.status.label_file": "文件",
  "ui.status.label_setting": "配置",
  "ui.status.label_folder": "文件夹",
  "ui.status.hash_calc": "哈希计算: ${pct}%",
  "ui.status.page_num": "${label} 页码 ${page}",
  "ui.status.sending": "${label} 发送中",
  "ui.status.buffer": "缓冲区: ${mb}MB",
  "setting.remote.option_cnb": "腾讯 cnb",
